...
export default class MainPage extends Page {
    ...
    createMainPage() {
        ...
        new Control(
            ...
            'Твоя цель не достигается, так как традиционные и "эффективные" подходы НЕ работают.'
        );
        new Control(
            this.container,
            'p',
            'main-page__description',
            'Работает регулярность (5 минут в день!) + наше приложение RSLang.'
        );
        ...
        link1Dwn.node.setAttribute('href', '/#games');
        ...
        link2Dwn.node.setAttribute('href', '/#stats');
