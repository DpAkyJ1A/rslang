...
export default class TeamPage extends Page {
    ...
    createTeamPage() {
        ...
        new Control(teamCards3.node, 'p', 'team-card__description', 'Собираю группу! Могу на гитаре и немного на барабанах, нужны бас и вокал.. P.S. Фронтэнд - это круто. Люблю рекурсию и регулярные выражения, в свободное время каррирую функции.'); 
        new Control(teamCards3.node, 'p', 'team-card__in-project', 'в проекте');
        new Control(teamCards3.node, 'p', 'team-card__description', 'Настраивал работу с бэкендом, реализовал Учебник, игру Спринт, разрабатывал общий дизайн, дизайн учебника и словаря, настроил роутинг для всего проекта.');
    }
}