...
export default class TeamPage extends Page {
    ...
    createTeamPage() {
        ...
        new Control(
            ...
            'p',
            'team-card__description',
            'Руководил. Настраивал проект, реализовал header, sidebar, footer. Разрабатывал общий дизайн, реализовал Словарь, страницу 404, Статистику по играм, добавил user experience в проект в виде кнопки "наверх".'
        );
        ...
        new Control(
            ...
            'p',
            'team-card__description',
            'Работала с получением данных от API, типизировала данные, реализовала Авторизацию и регистрацию, разрабатывала общий дизайн, дизайн главной страницы, адаптив.'
        );
        ...
        new Control(
            ...
            'p',
            'team-card__description',
            'Настраивал работу с бэкендом, реализовал Учебник, игру Спринт, разрабатывал общий дизайн, дизайн учебника и словаря, настроил роутинг для всего проекта.'
        );
    }
}
